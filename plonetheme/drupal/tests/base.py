...
def setup_product():
    ...
    # Load the ZCML configuration for the plonetheme.drupal package.
    # This can of course use <include /> to include other packages.

    fiveconfigure.debug_mode = True
    import plonetheme.drupal
    zcml.load_config('configure.zcml', plonetheme.drupal)
    ...
    ztc.installPackage('plonetheme.drupal')
...
setup_product()
ptc.setupPloneSite(products=['plonetheme.drupal'])
